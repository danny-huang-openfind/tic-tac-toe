...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const timer_elements = PLAYERS.reduce((result, player, index) => {
        var _a, _b;
        return (Object.assign(Object.assign({}, result), { [player]: (_b = (_a = info.children.namedItem("timer").children[index - 1]) === null || _a === void 0 ? void 0 : _a.children[0]) !== null && _b !== void 0 ? _b : null }));
    }, {});
    const buttons = ["start", "reset"].reduce((result, name, index) => (Object.assign(Object.assign({}, result), { [name]: actions.children[index] })), {});
    // #endregion
    ...
    function resetGame() {
        board = new Array(BOARD_SIZE).fill(null).map(() => new Array(BOARD_SIZE));
    ...
    function checkLine([x, y], direction, player) {
        ...
        while (count < WIN_LINE_LENGTH) {
            if (((_a = board === null || board === void 0 ? void 0 : board[x]) === null || _a === void 0 ? void 0 : _a[y]) !== player) {
                return false;
            }
            ++count;
    ...
    function init() {
        gamepad.append(...createElements("div", BOARD_SIZE ** 2, ["box", "bg--white", "d-flex", "justify-center", "items-center"]));
